...
def generate_svg():
  ...
  <defs>
    ...
    <!-- Weak glow filter for status light -->
  ...
  <g class="terminal-window">
    ...
    <!-- Status Activity Flashing Dot & Label in Header -->
    <g>
      <text x="562" y="35" class="header-status-label">ONLINE</text>
      <circle cx="572" cy="32" r="3.5" fill="#00ff87" filter="url(#glow-weak)">
    ...
    <!-- Line 5: CPU/RAM System Dashboard -->
    <g>
      <clipPath id="clip-status-4">
        <rect x="40" y="143" width="0" height="20">
          <animate attributeName="width" values="0;0;340;340;0" keyTimes="0;0.1500;0.1700;0.8500;1" dur="10.0s" repeatCount="indefinite" />
        </rect>
      </clipPath>
      <text x="40" y="155" class="status-text" clip-path="url(#clip-status-4)">[+] CPU [          ] 56% | RAM [          ] 42%</text>
      
      <!-- CPU Progress Bar Fill Rect -->
      <rect x="105.4" y="145" width="0" height="10" rx="1.5" ry="1.5" fill="#00ff87" filter="url(#glow-weak)">
        <animate attributeName="width" values="0;0;40.3;40.3;0" keyTimes="0;0.1700;0.2200;0.8500;1" dur="10.0s" repeatCount="indefinite" />
        <animate attributeName="opacity" values="0;0;1;1;0;0" keyTimes="0;0.1500;0.1501;0.8500;0.8501;1" dur="10.0s" repeatCount="indefinite" />
      </rect>
      
      <!-- RAM Progress Bar Fill Rect -->
      <rect x="271.0" y="145" width="0" height="10" rx="1.5" ry="1.5" fill="#60efff" filter="url(#glow-weak)">
        <animate attributeName="width" values="0;0;30.2;30.2;0" keyTimes="0;0.1700;0.2200;0.8500;1" dur="10.0s" repeatCount="indefinite" />
        <animate attributeName="opacity" values="0;0;1;1;0;0" keyTimes="0;0.1500;0.1501;0.8500;0.8501;1" dur="10.0s" repeatCount="indefinite" />
      </rect>
    </g>
